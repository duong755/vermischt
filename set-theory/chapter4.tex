...
Các kết quả dưới đây là cơ bản và cần thiết trong việc chứng minh tính thứ tự giữa các số nguyên.
...
\begin{proof}
	Chúng ta chứng minh tính tồn tại của cặp số nguyên như vậy. Hãy xem xét hai trường hợp. Bội của $b$ là số nguyên có dạng $b\cdot k$, trong đó $k$ là một số nguyên.

	\textbf{Trường hợp 1.} $b > 0$.

	Nếu hai số nguyên $x, y$ thỏa mãn $x < y$ thì $b\cdot x < b\cdot y$.

	Nếu $a\geq 0$ thì $a\leq 1$ ()

	\textbf{Trường hợp 2.} $b < 0$.

	Nếu hai số nguyên $x, y$ thỏa mãn $x < y$ thì $(-b)\cdot x < (-b)\cdot y$, kéo theo $b\cdot x > b\cdot y$.
