...
Nhận xét cuối cùng ngụ ý rằng nếu số tự nhiên $a$ lớn hơn $1$ thì các số tự nhiên $1, 2, \ldots, a - 1$ không chia hết cho $a$. Sau đây chúng ta phát biểu và chứng minh thuật toán chia Euclid. Nhưng trước tiên, chúng ta cần một định nghĩa.
...
\begin{definition}[Giá trị tuyệt đối của số nguyên]
	...
	được gọi là \textbf{ánh xạ giá trị tuyệt đối}, hay \textbf{hàm giá trị tuyệt đối} của số nguyên. $\abs{x}$ được gọi là giá trị tuyệt đối của số nguyên $x$.
\end{definition}
