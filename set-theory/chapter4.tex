...
\begin{theorem}\label{theorem:integers-order-and-multiplication}
...
\begin{proof}
	...
	Nếu $\alpha < [(0,0)]$ thì theo định nghĩa của phép nhân số nguyên (trường hợp 4), $\alpha\cdot\alpha = (-\alpha)\cdot(-\alpha)$. Vì $\alpha < [(0,0)]$ nên theo Định lý~\ref{theorem:integers-order-and-operations}, chúng ta có $[(0,0)] < (-\alpha)$. Theo Hệ quả~\ref{corollary:integers-order-and-multiplication}, chúng ta có $[(0,0)] < (-\alpha)\cdot(-\alpha) = \alpha\cdot\alpha$.
...
\begin{theorem}\label{theorem:solution-of-linear-equation-part-1}
...
Quan hệ $\leq$ trên tập hợp số hữu tỉ có những liên hệ sau đây với các phép toán cộng và nhân số hữu tỉ.
