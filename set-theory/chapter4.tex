...
\[
	\zeta_{k} = \cos\left(\frac{2k\pi}{n}\right) + \imath\sin\left(\frac{2k\pi}{n}\right).
\]
...
\begin{figure}[htp]
	...
	\begin{tikzpicture}[>=Stealth,scale=2.0]
		...
		\tkzMarkAngle[size=0.30cm,->,mark=|,mkpos=0.5](X,O,Z1);
		\tkzMarkAngle[size=0.45cm,->,mark=||,mkpos=0.5](X,O,Z2);
		\tkzMarkAngle[size=0.30cm,->,mark=|,mkpos=0.5](Z2,O,Z);
		\tkzMarkAngle[size=0.65cm,->](X,O,Z);
...
\begin{figure}[htp]
	...
	\begin{tikzpicture}[>=Stealth,scale=2.0]
		...
		\draw[->] (0,-1.5)--(0,1.5) node[above]{$y\imath$};
	\end{tikzpicture}
	\caption{Các căn bậc $5$ của $1$.}\label{fig:5throot-of-unity}
\end{figure}
