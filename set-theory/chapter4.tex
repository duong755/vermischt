...
\section{Hệ tiên đề Peano về các số tự nhiên}\label{section:peano-axioms}
...
Từ mệnh đề vừa chứng minh, chúng ta rút ra một hệ quả: Nếu $x\leq y$ thì \textit{tồn tại duy nhất} số tự nhiên $z$ sao cho $x + z = y$. Đây là cơ sở để chúng ta định nghĩa phép trừ hai số tự nhiên.
...
\subsection*{Các quan hệ trên tập hợp số nguyên}

\begin{definition}[Quan hệ thứ tự trên tập hợp số nguyên]
	Cho hai số nguyên $x$ và $y$. Chúng ta nói $x$ nhỏ hơn hoặc bằng $y$, và kí hiệu $x\leq y$ nếu và chỉ nếu tồn tại \textit{số nguyên không âm} $z$ sao cho $x + z = y$.
\end{definition}

\begin{definition}[Quan hệ đồng dư trên tập hợp số nguyên]
	Cho các số nguyên $x, y$ và $n$, trong đó $n\ne 0$. Chúng ta nói \textbf{$x$ đồng dư $y$ modulo $n$} nếu và chỉ nếu $x - y$ chia hết cho $n$. Khi đó, chúng ta kí hiệu $x\equiv y\pmod{n}$ hoặc $x\equiv_{n}y$.
\end{definition}
...
\subsection*{Các phép toán tập hợp số hữu tỉ}
