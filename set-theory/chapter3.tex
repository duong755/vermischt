...
\begin{exercise}\label{exercise:well-ordered-set}
    Một tập hợp được sắp thứ tự toàn phần được gọi là \textit{tập hợp được sắp thứ tự tốt\index{Tập hợp được sắp thứ tự tốt}} khi và chỉ khi mỗi tập hợp con khác rỗng của tập hợp đó đều có phần tử nhỏ nhất. Chứng minh rằng
    \begin{enumerate}[label={(\roman*)}]
...
\begin{exercise}[Phần nguyên của số hữu tỉ]
